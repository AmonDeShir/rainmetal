...
use crate::memory::systems::{init_city_memory, init_driver_position_memory, on_driver_removed, on_location_removed, share_memory_on_enter, share_memory_on_exit, update_driver_position_memory, update_location_economy_memory, update_location_money_memory, update_location_storage_memory};
...
impl Plugin for MemoryPlugin {
    fn build(&self, app: &mut App) {
        ...
        app.add_systems(Update, update_location_money_memory);
