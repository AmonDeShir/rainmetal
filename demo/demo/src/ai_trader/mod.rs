...
use crate::ai_trader::systems::{update_state_trading_plans, update_trading_plans};
...
impl Plugin for AiTraderPlugin {
    fn build(&self, app: &mut App) {
        ...
        app.add_systems(Update, update_trading_plans.run_if(on_timer(Duration::from_secs(5))));
